...
tests_folder = r"C:/Users/artur/OneDrive/Documentos/Tecnico- 2ºano/P4- Inteligência artificial/Projeto/Project-IA/Tester/Testes"
results_folder = r"C:/Users/artur/OneDrive/Documentos/Tecnico- 2ºano/P4- Inteligência artificial/Projeto/Project-IA/Tester/Outputs"
bimaru_script = r"C:/Users/artur/OneDrive/Documentos/Tecnico- 2ºano/P4- Inteligência artificial/Projeto/Project-IA/bimuru.py"
errors_in_tests = []
...
for file_name in os.listdir(tests_folder):
    if file_name.endswith(".txt"):
        ...
        result = subprocess.run(["python", bimaru_script], input=open(test_file_path, 'rb').read(),
